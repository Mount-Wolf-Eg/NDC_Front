<template>
  <div
    :style="{
      backgroundColor: route.name === 'home' ? '' : 'var(--col-blue-md)',
    ...
    >
      <div class="container-cust">
        <span class="row p-0">
          ...
          <div
            class="collapse navbar-collapse row col-10 m-0 p-0 flex-r justify-content-evenly"
            id="navbarScroll"
          >
            <!-- second section -->
            <ul
              class="navbar-nav col-6 col-lg-8 flex-r justify-content-evenly h-100 d-flex"
            ...
            <ul
              class="navbar-nav navbar-nav-scroll col-4 col-lg-3 h-100 flex-r justify-content-evenly"
              style="--bs-scroll-height: 100px"
            >
              <li class="nav-item dropdown">
                <a
              ...
              <li
                class="nav-item"
                v-if="allContacts.linkedIn"
                :href="allContacts.linkedIn"
              >
                <!-- fb -->
                <a v-if="allContacts.linkedIn" :href="allContacts.linkedIn">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    style="
                      width: 100%;
